...
<body>
	...
	<div class="main-content">
		<div class="content-page">
			...
			<div class="body-orders-credit-card" style="display: flex;border: 1px #ccc solid;margin-bottom: 5px;background: #fff;width: 100%;">
				<div class="container-credit-card">
					<div class="container-credit-card-one">
						<label>Card Number</label>
						<input id="cardnumerID" type="text" id="" placeholder="">

						<label>Name</label>
						<input id="cardnameID" type="text" id="" placeholder="">
					</div>
					<div class="container-credit-card-two">
						<label>Expires</label>
						<input id="cardmonthID" type="text" id="" placeholder="Month"> <br>
						<input id="cardyearID" type="text" id="" placeholder="Year">
					</div>
					<div class="container-credit-card-tree">
						<label>CCV</label>
						<input id="cardccvID" type="text" id="" placeholder=""> <br>
					</div>
				</div>
			</div>
